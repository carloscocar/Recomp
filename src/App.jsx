...
/* ============================ meal analysis ============================ */
// iPhones shoot HEIC, which the image model can't read, and full-res photos are
// huge. Convert everything to a downscaled JPEG in the browser before sending.
...
function describeMealError(msg = "") {
  ...
  return "Couldn't read that one — try a clearer, closer shot, or add it manually below.";
}
